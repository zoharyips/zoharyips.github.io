...
* 浏览器端
    ...
    ![运行结果](https://zoharyips.github.io/images/posts/deferred-result-message-queue/browser.gif "运行结果")

* 控制台端

    ![运行结果](https://zoharyips.github.io/images/posts/deferred-result-message-queue/console.png "运行结果")